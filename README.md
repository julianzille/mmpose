...
All code specific to this project can be found in the [AnimalPose.ipynb](https://github.com/julianzille/mmpose/blob/master/AnimalPose.ipynb) Jupyter Notebook. Function definitions (including MMPose function adaptations) can be found in [setup_env.py](https://github.com/julianzille/mmpose/blob/master/setup_env.py). 
